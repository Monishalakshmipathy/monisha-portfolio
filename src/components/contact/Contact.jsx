    ...
    <section id='contact' data-aos='fade-up' data-aos-delay='400'>
        <div className='py-8 lg:py-16 mx-auto max-w-screen-md'>
            ...
            <form action='#' className='space-y-8'>
                ...
                <button className='inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 hover:shadow-[0_0_40px_rgba(0,165,255,0.7)] rounded-full text-lg'>
                    Send Message
                </button>
            </form>
        </div>
